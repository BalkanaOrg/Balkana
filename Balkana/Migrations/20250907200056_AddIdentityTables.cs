    ...
    public partial class AddIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CorePlayers", x => new { x.CoreId, x.PlayerId });
                    table.ForeignKey(
                        name: "FK_CorePlayers_Cores_CoreId",
                        column: x => x.CoreId,
                        principalTable: "Cores",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CorePlayers_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoreTournamentPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoreTournamentPoints_Cores_CoreId",
                        column: x => x.CoreId,
                        principalTable: "Cores",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CoreTournamentPoints_Tournaments_TournamentId",
                        column: x => x.TournamentId,
                        principalTable: "Tournaments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorePlayers_PlayerId",
                table: "CorePlayers",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_CoreTournamentPoints_CoreId",
                table: "CoreTournamentPoints",
                column: "CoreId");

            migrationBuilder.CreateIndex(
                name: "IX_CoreTournamentPoints_TournamentId",
                table: "CoreTournamentPoints",
                column: "TournamentId");
